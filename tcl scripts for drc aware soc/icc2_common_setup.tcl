...
set REFERENCE_LIBRARY 		[list /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/sky130_v5_7magic.lef /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/avsdpll.lef /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/avsddac.lef]	;# Required; a list of reference libraries for the design library.
...
set VERILOG_NETLIST_FILES	"/home/ganesh/Collateral/Files/output/vsdbabysoc_gtlvl.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TCL_PARASITIC_SETUP_FILE	"/home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/init_design.read_parasitic_tech_example.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;
					;# refer to the example in templates/init_design.read_parasitic_tech_example.tcl 

#set TCL_MCMM_SETUP_FILE         ""
set TCL_MCMM_SETUP_FILE		"/home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/init_design.mcmm_example.auto_expanded.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set TECH_FILE 			"/home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/sky130_fd_sc_hd.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
					;# TECH_FILE is recommended, although TECH_LIB is also supported in ICC2 RM. 
set TECH_LIB			"/home/ganesh/ICC2Exp/VSDBabySoC_ICC2/sky130_fd_sc_hd__tt_025C_1v80.lib"	;# Specify the reference library to be used as a dedicated technology library;
...
set TCL_TECH_SETUP_FILE		"/home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/init_design.tech_setup.tcl"
...
set LINK_LIBRARY		[list /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/avsddac.db /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/avsdpll.db /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/sky130_fd_sc_hd__tt_025C_1v80.db]	;# Specify .db files;
...
##########################################################################################
set DESIGN_STYLE		"heir"	;# Specify the design style; flat|hier; default is flat; 
