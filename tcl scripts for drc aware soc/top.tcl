source -echo /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/icc2_common_setup.tcl
source -echo /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/icc2_dp_setup.tcl
...
if {$DP_FLOW == "hier" && $BOTTOM_BLOCK_VIEW == "abstract"} {
   ...
   puts "RM-info : Design Name(${DESIGN_NAME}/${INIT_DP_LABEL_NAME}) Verilog outline file (${VERILOG_NETLIST_FILES}) loaded"
   } else {
   ...
   puts "RM-info : Full chip Verilog file (${VERILOG_NETLIST_FILES}) loaded"
}
...
# Floorplanning
####################################
#initialize_floorplan -core_utilization 0.1 
...
set write_block_data_script /home/ganesh/ICC2Exp/VSDBabySoC_ICC2/standaloneFlow/write_block_data.tcl
